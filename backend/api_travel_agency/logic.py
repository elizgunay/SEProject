...
def add_location(request):
    ...
    try:
        ...
        location.save()
        return {'Result': 'Successfully created the location!'}
    except Exception:
        return {'Result': 'An error occurred while creating the location!'}
...
def get_location_by_id(request):
    ...
    try:
        ...
        return {'Error': f'No location found with the specified id {location_id}!'}
...
def add_holiday(request):
    ...
    try:
        ...
        holiday.save()
        return {'Result': 'Successfully created the holiday!'}
    except Exception:
        return {'Result': 'An error occurred while creating the holiday!'}
...
def edit_holiday(request):
    ...
    try:
        ...
        return {'Result ': 'No holiday found with the specified id'}
...
def add_reservation(request):
    ...
    try:
        ...
        reservation.save()
        return {'Result': 'Successfully created the reservation! '}
    except Exception:
        return {'Result': 'An error occurred while creating the reservation!'}
...
def delete_reservation(request):
    ...
    try:
        ...
        return {'Result': 'Could not find reservation with that id!'}
...
def get_reservation_by_id(request):
    ...
    try:
        ...
        return {'Result': 'No reservation found with the specified ID!'}
    ...
    try:
        ...
        if location_id:
            try:
                ...
                return {'Result': 'No location found with the specified ID!'}
